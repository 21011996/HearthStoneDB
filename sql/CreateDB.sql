...
CREATE OR REPLACE VIEW Weapon_cards AS
    SELECT card_name, card_description, set_name, card_score
    FROM Weapons
...
CREATE VIEW Spell_cards AS
    SELECT card_name, card_description, class_name, set_name, card_score
    FROM spells
...
CREATE VIEW Minion_cards AS
    SELECT card_name, card_description, class_name, race,  set_name, card_score
    FROM Minions
